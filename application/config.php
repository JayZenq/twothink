...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'dJAa_E*bFc?PM!1#^&6]X}9f(-%lx|;nYQK`LD>p', //默认数据加密KEY
	'data_cache_key'=> 'dJAa_E*bFc?PM!1#^&6]X}9f(-%lx|;nYQK`LD>p',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'dJAa_E*bFc?PM!1#^&6]X}9f(-%lx|;nYQK`LD>p', //加密KEY

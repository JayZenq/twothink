<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\www\twothink\public/../application/user/view/default/login\online.html";i:1533797121;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
        <form>
            <div class="form-group">
                <label>用户名:</label>
                <!--<input type="text" class="form-control"  placeholder="请输入用户名" name="username" datatype="*1-16"/>-->

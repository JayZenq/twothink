<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\www\twothink\public/../application/home/view/default/index\index.html";i:1533865474;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <nav class="navbar navbar-default navbar-fixed-bottom">
        <div class="container-fluid text-center">
            ...
            <div class="col-xs-3">
                <?php if(is_login()): ?>
                <p class="navbar-text"><a href="/index/my.html" class="navbar-link">我的</a></p>
                <?php else: ?>
        ...
        <div class="serviceList text-center">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo url('Ticket/add','pid='.$pid); ?>">
